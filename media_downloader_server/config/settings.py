...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-ld%%odhsbxd-@5a3!edwevvx!i$h_x0euky(-_p-s^li1uai5w',
)
...
# Fernet key used to encrypt Instagram session blobs at rest. Generate with:
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'downloader.authentication.HasAPIKey',
    ],
}
...
# Third-party API credentials (personal use, loaded from .env — never commit)
